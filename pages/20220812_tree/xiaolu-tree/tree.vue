      ...
      <view class="title">
        ...
        >
          ...
          >
            ...
            >
              <text v-if="index == tree_stack.length - 1 && !isre" class="none"
                >全部</text
              >
            ...
            >
              <i
                v-if="
                  ...
                  item[checkDataId] == newCheckList[0][checkDataId]
                "
  ...
  methods: {
    ...
    checkbox(item, index) {
      ...
      if (!that.uncheckThe) {
        ...
        if (
          that.newCheckList.length > 0 &&
          that.newCheckList[0].organId == that.tree[index].organId
        ) {
          that.newCheckList = [];
        } else {
          that.newCheckList = [];
