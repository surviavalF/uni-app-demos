      ...
      <view v-for="(item, index) in loopCharArr" :key="index">
        ...
        >
          ...
          <view
            ...
            class="u-bottom-line"
            :style="{
              height: bold ? '4rpx' : '2rpx',
              background:
                charArrLength > index ? isInputFinishColor : charArrLength === index ? activeColor : inactiveColor
            }"
          ></view>
 ...
 * @property {String} active-color 当前激活输入框的样式（默认#ff6a00）
