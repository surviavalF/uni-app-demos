<template>
  <view class="u-avatar" :style="[wrapStyle]" @tap="click">
    ...
    <view class="u-avatar__level" v-if="showLevel" :style="[uLevelStyle]">
      <u-icon :name="levelIcon" color="#fff" size="20"></u-icon>
    </view>
  </view>
</template>
...
<script>
let base64Avatar =
'data:image/svg+xml;base64,'
/**
 * avatar 头像
