    ...
    >
      <view class="u-select">
        ...
        <view class="u-select__body">
          <view class="loading-box" v-if="list.length === 0"><u-loading mode="flower"></u-loading></view>
          <picker-view
            v-else
            @change="columnChange"
          ...
          >
            <picker-view-column v-for="(item, index) in columnData" :key="index">
              <view class="u-select__body__picker-view__item" v-for="(item1, index1) in item" :key="index1">
                <view class="u-select__body__picker-view__item__lableName u-line-2">{{ item1[labelName] }}</view>
              </view>
            </picker-view-column>
          </picker-view>
        </view>
 ...
 * @property {String} confirm-color 确认按钮的颜色(默认#4986fb)
  ...
  methods: {
    ...
    setDefaultSelector() {
      ...
      this.defaultSelector =
        this.defaultValue.length == this.columnNum ? this.defaultValue : Array(this.columnNum).fill(0)
