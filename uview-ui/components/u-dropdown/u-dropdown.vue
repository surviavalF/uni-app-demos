  ...
  <view class="u-dropdown">
    ...
    >
      <view class="u-dropdown__menu__item" v-for="(item, index) in menuList" :key="index" @tap.stop="menuClick(index)">
        <view class="u-flex">
          <view
            class="u-dropdown__menu__item__text dropdown__custom u-line-1"
            :style="{
              color: item.disabled
                ? '#c0c4cc'
 ...
 * @property {String} active-color 标题和选项卡选中的颜色（默认#ff6a00）
...
export default {
  ...
  methods: {
    ...
    open(index) {
      ...
      this.contentHeight = this.dropdownContentHeight
    ...
    getContentHeight() {
      ...
      this.$uGetRect('.u-dropdown__menu').then(res => {
        ...
        this.dropdownContentHeight = windowHeight - res.bottom
      })
    }
  }
}
